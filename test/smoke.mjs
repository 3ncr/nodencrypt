// Smoke test: consume the published ESM build via import.
// Mirrors the entry path real ESM users will hit.
import assert from 'node:assert';
import { NodenCrypt } from '../dist/esm/nodencrypt.js';
...
console.log('[OK] ESM smoke test (import) passed against dist/esm');
